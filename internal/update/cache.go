...
// cacheTTL is the cache time-to-live duration (1 hour)
...
return time.Since(c.LastChecked) >= cacheTTL
}
...
// IsCacheValid checks if the cached version exists and is not expired
func IsCacheValid(dataDir string) (bool, error) {
...
return !cached.IsCacheExpired(), nil
}
